...
TEST_CASE("Generate figure from STDIN stream", "[stream_figure_factory]") {
...
TEST_CASE("Complex case generating figure from STDIN", "[stream_figure_factory]") {
...
TEST_CASE("Generate figure from file stream", "[stream_figure_factory]") {
...
TEST_CASE("Complex case generating figure from file stream", "[stream_figure_factory]") {
...
TEST_CASE("Handle invalid input from STDIN stream", "[stream_figure_factory]") {
...
TEST_CASE("Handle invalid input from file stream", "[stream_figure_factory]") {
...
TEST_CASE("Handle end of stream or EOF", "[stream_figure_factory]") {
...
TEST_CASE("Handle trailing characters after valid figure", "[stream_figure_factory]") {
    std::istringstream istream("circle 10\n");
    StreamFigureFactory factory(istream);
    std::unique_ptr<Figure> figure = factory.create_figure();
    REQUIRE(figure != nullptr);
